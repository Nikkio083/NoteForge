    ...
    <div class="sidebar-content">
      ...
      <div v-if="activeTab === 'related'" class="tab-content">
        ...
        <div class="related-files">
          ...
          <div v-for="(relatedFile, index) in relatedFiles" :key="index" class="related-file">
...
const currentUser = 'Utente Attuale'; // Da sostituire con il vero nome utente
...
//const relatedFiles = ref(fileStore.searchFile(props.file?.tags[0].toString()));
